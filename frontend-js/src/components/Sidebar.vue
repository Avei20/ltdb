<template>
    <div class="min-h-screen bg-gray-100">
        <div class="sidebar min-h-screen w-[3.35rem] overflow-hidden border-r hover:w-56 hover:bg-white hover:shadow-lg">
            ...
            <div>
                <div class="flex flex-wrap w-max p-2.5">
                ...
                <li class="min-w-max">
                    <router-link to="/" aria-label="dashboard" class="relative flex items-center space-x-4 bg-gradient-to-r from-green-600 to-cyan-400 px-4 py-3 text-white">
                ...
                <li class="min-w-max">
                    <router-link to="/murid" class="bg group flex items-center space-x-4 rounded-full px-4 py-3 text-gray-600">
