-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'GURU', 'MURID', 'KEPALA_TAHFIDZ', 'PARENT', 'TU', 'INPUT_QURAN');
...
-- CreateEnum
CREATE TYPE "EventModelType" AS ENUM ('USER', 'GURU', 'KELOMPOK_TAHFIDZ', 'MURID', 'PARENT', 'SESSION', 'ALQURAN', 'JAM_TAHFIDZ');

-- CreateEnum
CREATE TYPE "GolonganDarah" AS ENUM ('A', 'B', 'O', 'AB');
...
-- CreateIndex
CREATE UNIQUE INDEX "GuruDetails_userId_key" ON "GuruDetails"("userId");
...
-- CreateIndex
CREATE UNIQUE INDEX "MuridDetails_userId_key" ON "MuridDetails"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "Parent_nip_key" ON "Parent"("nip");

-- CreateIndex
CREATE UNIQUE INDEX "ParentDetails_userId_key" ON "ParentDetails"("userId");
